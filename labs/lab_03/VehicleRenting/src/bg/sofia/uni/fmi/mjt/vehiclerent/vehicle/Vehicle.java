...
public abstract class Vehicle {
    ...
    public void rent(Driver driver, LocalDateTime startRentTime) {
        if(driver != null)
        {
            throw new VehicleAlreadyRentedException("The vehicle is already taken!");
        }
    ...
    public void returnBack(LocalDateTime rentalEnd) throws InvalidRentingPeriodException {
        if(driver == null)
        {
            throw new VehicleNotRentedException("The vehicle hasn't been rented at all.");
        }

        if(rentalEnd.isBefore(startRentTime))
            throw new InvalidRentingPeriodException("Invalid end of rent time.");
